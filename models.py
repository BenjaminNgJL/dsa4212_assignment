...
class DecoderOnlyTransformer(nn.Module):
    ...
    def setup(self):
        ...
        if self.pos_encoding == 'learned':
            ...
            self.positional_embed = get_sinusoidal_embeddings(self.max_len, self.d_model)
        else:
            raise ValueError(f"pos_encoding must be 'learned' or 'sinusoidal', got {self.pos_encoding}")
